function [ output ] = ft_load_fiff_trials( input_file, event_file, prestim, poststim )
...
%   
%   Usage: [ output ] = ft_load_fiff_trials( input_file, event_file,
%   prestim, poststim )
%
%   Input:
...
%
%   Last update May 11 2011, by Kai
