function [ Output ] = Load_MNEsources_to_ft_wrapper(subs, runs, source, source_cond, event_cond, event_type, sr, prestim, poststim, RLflag)
%This is a wrapper function that calls MEG_load_label_source_trial to load
%multiple runs of data from multiple subjects into a FT structure.
%
%   Inputs:
